...
var availableCosts = function (cars) {
...
c_it('bonus 1: mine:> ' + availableCosts(CARS));
...
c_it('bonus 2: them:> ' + fastestCar(CARS));
var powerfullestCar = function (cars){
    var _sorted =  _.sortBy(_.prop('horsepower'));
    var best = _.last;
    var bestPower = _.compose(best,_sorted)(cars);
    return bestPower['name'] + ' is the powerfullest.';
};
c_it('bonus 2: mine:> ' + powerfullestCar(CARS));